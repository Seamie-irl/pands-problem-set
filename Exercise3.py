...
# It only matters about 6 being the divisor and whether 12 divides in this case
...
for i in range(1000,10000):
    if i%6 == 0: #cound't figure out why this line was showing up as an error. ==!!! Not used to double equals!
        # now test for 12
